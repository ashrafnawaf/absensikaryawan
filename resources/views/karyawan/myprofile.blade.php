                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                            <b> No Telepon</b> <a class="float-right">{{ auth()->user()->telepon }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" disabled value="{{ auth()->user()->Jabatan->nama_jabatan }}">
                                        </div>
                                        <div class="col">
                                            <label for="lokasi_id">Lokasi Kantor</label>
                                            <input type="text" class="form-control" disabled value="{{ auth()->user()->Lokasi->nama_lokasi }}">
                                        </div>
                                    </div>
                                    <br>
