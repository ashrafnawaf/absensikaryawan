              ...
              <div class="card">
                ...
                <div class="card-body"> -->
                  ...
                  <!-- <div id="external-events">
                    <div class="external-event bg-success">Proyek Surabaya</div>
                    <div class="external-event bg-warning">Proyek Malang</div>
                    <div class="external-event bg-info">Proyek Madiun</div>
                    <div class="external-event bg-primary">Proyek Batu</div>
