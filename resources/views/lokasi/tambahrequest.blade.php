...
<div class="container-fluid">
    <div class="row">
        <div class="card col-lg-5">
            <div class="p-4">
                <center>
                    <h2 style="font-family: Playfair Display, sans-serif; font-weight: bold; color: orange;">MANUAL</h2>
                </center>
                <br>
        ...
        <div class="col-lg-2">
            <!-- <center>
                <h1 style="color: white">Atau</h1>
            </center> -->
        </div>
        <div class="card col-lg-5">
            <div class="p-4">
                <center>
                    <h2 style="font-family: Playfair Display, sans-serif; font-weight: bold; color: orange;">OTOMATIS</h2>
                </center>
                <br>
                <form method="post" action="{{ url('/request-location/tambah-proses') }}">
                    @csrf
